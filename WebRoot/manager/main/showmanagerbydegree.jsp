 ...
 <div class="rt_content">
      ...
      <table class="table">
       ...
       <tr>
        ...
        <td class="center">
        <s:set var="flag" value="#manager.adminflag"/>
      ...
      <aside class="paging">
      <a href="showdDegreeManager?pageNo=1&id=${flag}">首页</a>
		<c:choose>
			<c:when test="${currentPage>1}">
					<a href="showdDegreeManager?pageNo=${currentPage-1}&id=${flag}">上一页</a>
				</c:when>
		</c:choose>
		<c:choose>
			<c:when test="${currentPage<totalPage}">
					<a href="showdDegreeManager?pageNo=${currentPage+1}&id=${flag}">下一页</a>
				</c:when>
		</c:choose>
		<a href="showdDegreeManager?pageNo=${totalPage}&id=${flag}">尾页</a>
