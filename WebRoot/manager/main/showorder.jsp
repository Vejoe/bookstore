...
<html>
 ...
 <div class="rt_content">
      <div class="page_title">
       <h2 class="fl">订单列表</h2>
       <a href="queryBookTypeAction" class="fr top_rt_btn add_icon" target="mainframe">添加商品</a>
      </div>
      <section class="mtb">
      ...
      <aside class="paging">
      <a href="showAllOrder?pageNo=1">首页</a>
		<c:choose>
			<c:when test="${currentPage>1}">
					<a href="showAllOrder?pageNo=${currentPage-1}">上一页</a>
				</c:when>
		</c:choose>
		<c:choose>
			<c:when test="${currentPage<totalPage}">
					<a href="showAllOrder?pageNo=${currentPage+1}">下一页</a>
				</c:when>
		</c:choose>
		<a href="showAllOrder?pageNo=${totalPage}">尾页</a>
