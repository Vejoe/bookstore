...
<html>
 ...
 <div class="rt_content">
      ...
      <aside class="paging">
      <a href="showAllMessage?pageNo=1">首页</a>
		<c:choose>
			<c:when test="${currentPage>1}">
					<a href="showAllMessage?pageNo=${currentPage-1}">上一页</a>
				</c:when>
		</c:choose>
		<c:choose>
			<c:when test="${currentPage<totalPage}">
					<a href="showAllMessage?pageNo=${currentPage+1}">下一页</a>
				</c:when>
		</c:choose>
		<a href="showAllMessage?pageNo=${totalPage}">尾页</a>
