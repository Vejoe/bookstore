...
<html>
  ...
  <body>
    ...
    <hr color="red">
    <b>添加收货人</b>
	<s:form method="post" action="AddConsigneeAction">
		...
		<table>
			...
			<tr class="tr">
				<td>&nbsp;收货人手机号:</td>
				<td><s:textfield maxlength="13" onkeyup="this.value=this.value.replace(/\D/gi,'')" cssStyle="height:30px" size="35" name="consignee.phone_num" theme="simple" placeholder="请输入收货人手机号"/></td>
				<td class="sign">*</td>
		    ...
		    <tr class="tr">
			    <td>&nbsp;收货人地址:</td>
			    <td id="doubleselect">
				    <s:select id="sheng" name="consignee.province" list="#{'-1':'请选择省'}" theme="simple"></s:select>
			    	<s:select id="shi" name="consignee.city" list="#{'-1':'请选择市'}" theme="simple"></s:select>
			    	<s:select id="qu" name="consignee.area" list="#{'-1':'请选择区'}" theme="simple"></s:select>
		   		</td>
		   		<td class="sign">*</td>
