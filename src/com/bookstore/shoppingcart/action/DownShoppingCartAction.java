...
public class DownShoppingCartAction extends ActionSupport{
	...
	public void setShoppingcartinfos2(List<ShoppingCartInfo> shoppingcartinfos) {
	...
	public String execute(){
		...
		if(ordermount>1&&shoppingcartdao.delShoppingcartbook(id,ordermount,price)){
			shoppingcartinfos=shoppingcartdao.showshoppingcartInfo(cartid);//得到购物车集合
			if(shoppingcartinfos==null)return INPUT;
